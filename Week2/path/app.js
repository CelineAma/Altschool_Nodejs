...
// // Get the base name
// const baseName = path.basename('C:\Users\Amarachi Celine\Desktop\Week2\path\package.json');
// console.log(baseName);

// // Get the directory name
// const dirName = path.dirname('C:\Users\Amarachi Celine\Desktop\Week2\path\package.json');
// console.log(dirName);

// // Get the extension name
// const extName = path.extname('C:\Users\Amarachi Celine\Desktop\Week2\path\package.json');
// console.log(extName);
